    ...
    render(){
        return(
            <View style ={styles.container}>
                ...
                <Text style = {styles.perdidosnoespaço}> App Nasa </Text>
                </View>
                ...
                onPress = {()=>this.props.navigation.navigate("IssLocation")}>
                    ...
                    <Image source={require("../assets/iss_icon.png")} style = {styles.kyuubi}></Image>
                </TouchableOpacity>
                <TouchableOpacity style ={styles.chicken}
                onPress = {()=>this.props.navigation.navigate("Meteors")}>
                    ...
                    <Image source={require("../assets/meteor_icon.png")} style = {styles.kyuubi}></Image>
                </TouchableOpacity>
                </ImageBackground>
            </View>
        )
